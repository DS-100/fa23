...
<li><b>Checkpoint 1: EDA:</b> You will need to submit a write-up + code for preliminary EDA on your dataset. You will also have to submit an internal peer review here. Please see below for more information. </li>
...
<li><b>Checkpoint 3: Project Report First Draft:</b> This will be your first draft; you will be required to submit a report of your findings as well as any code necessary to reproduce your results. You will also have to submit an internal peer review here. More information will be announced later.</li>
